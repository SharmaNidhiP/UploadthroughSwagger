...
namespace WebApiCRUDSwagger.Controllers;
    ...
    public class UploadFileController : ControllerBase
    {
        ...
        public UploadFileController(DataBaseFirstEfContext dbContext)
        {
        ...
        public async Task<IActionResult> UploadExcel(IFormFile file)
        {
            ...
            using (var package = new ExcelPackage(file.OpenReadStream()))
            {
                ...
                for (int row = 2; row <= rowCount; row++) // Assuming the first row contains headers
                {
                    ...
                    {
                        ApplicationId = worksheet.Cells[row, 2].Value?.ToString(),
                ...
                await _dbContext.ApplicationLists.AddRangeAsync(applications);
